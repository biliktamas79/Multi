...
namespace Multi.Data.UnitOfWork
{
    ...
    public abstract partial class UnitOfWorkBaseAsync : DisposableBase, IOwnedByThread, IUnitOfWorkBaseAsync, IFluentInterface
    {
		...
		#region CONSTRUCTORS
        protected UnitOfWorkBaseAsync(DbContextBase dbContext, int uowId, ILogger logger, int reposDictionaryInitialCapacity = 0)
		{
                ...
                switch (currentChangeState)
                {
                    case UowChangeStateEnum.HasChanges:
                        ...
                        try
                        {
                            ...
                            await DoCommit().ConfigureAwait(false);
                ...
                switch (currentChangeState)
                {
                    case UowChangeStateEnum.HasChanges:
                        ...
                        try
                        {
                            ...
                            await DoRollback().ConfigureAwait(false);
